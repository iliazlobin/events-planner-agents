...
TOOL_EXPAND_DROPDOWN_MENU: ToolSchema = _load_tool(
    {
        "type": "function",
        "function": {
            "name": "expand_dropdown_menu",
            "description": "Expands a dropdown menu by clicking on the dropdown field to explore available valid options.",
            "parameters": {
                "type": "object",
                "properties": {
                    "reasoning": {
                    ...
                    "target_id": {
                        "type": "integer",
                        "description": "The numeric id of the input field that represents a dropdown menu.",
                    },
                },
                "required": ["reasoning", "target_id"],
            },
...
TOOL_COMPLETE: ToolSchema = _load_tool(
    {
        "type": "function",
        "function": {
            "name": "complete",
            ...
            "parameters": {
                ...
                "properties": {
                    "status": {
                        "type": "boolean",
                        "description": "Indicates whether the task was successfully completed.",
                    },
                    "reasoning": {
                        "type": "string",
                        "description": "Reasoning behind the completion status.",
                    },
                },
...
TOOL_ERROR: ToolSchema = _load_tool(
    {
        "type": "function",
        "function": {
            "name": "error",
            "description": "Indicates that an error has occurred during the execution of the task.",
            "parameters": {
                "type": "object",
                "properties": {
                    "message": {
                    ...
                    "reasoning": {
                        "type": "string",
                        "description": "The reasoning behind the error.",
                    },
                },
                "required": ["error", "message", "reasoning"],
            },
        },
    }
)
